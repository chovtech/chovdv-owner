...
$view_for_policy_select = "SELECT * FROM `policy` WHERE `sn` = '$emma_get_data_id' AND `InstitutionID` = '$emma_get_this_institution' ";
    ...
    //   echo  $combinedContentForView;
        ...
        echo '
            ...
            <div class="row mt-2">
                ...
                <label><input type="checkbox" id="myCheckboxforview" value="accept"> Check me to enable the continue button</label>
                </div>
            </div>';
