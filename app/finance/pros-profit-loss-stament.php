                    ...
                    <div class="row g-2">
                        <div class="col-md-2 col-lg-2">
                            <select style="color: #666666;"
                                    class="form-select form-select-sm pros-load-campuspostransaction-lossstatement"
                        ...
                        <div class="col-md-2 col-lg-2">
                            <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosgetsession-profitloss-stament">
                        ...
                        <div class="col-md-3 col-lg-2">
                                    ...
                                    <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosloaterm-profitstatement">
                                ...
                                <div class="col-md-2 col-lg-2">
                                    <div class="form-group" style="display: flex;">
                                        ...
                                        <button type="button"
                                            ...
                                            class="btn btn-primary btn-sm pros-loadprofit-loss-btn">Load</button>
        ...
        <div class="table-Side-Chi topSecCards" style="padding: 20px 20px 20px 20px;">
            <div class="table-responsive prosload-loss-stamentcontent-here">
                        <div align="center" id="pros-load-profit-loss-statement">
