            ...
            <div class="row g-2">
                    <div class="col-md-2 col-lg-2">
                        <select style="color: #666666;"
                                class="form-select form-select-sm pros-load-campuspostransaction-schoolproceed"
                    ...
                    <div class="col-md-2 col-lg-2">
                        <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosgetsession-schoolproceed">
                    ...
                    <div class="col-md-3 col-lg-2">
                        <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosloaterm-schoolproceed">
                    ...
                    <div class="col-md-2 col-lg-2">
                        <div class="form-group" style="display: flex;">
                            ...
                            <button type="button"
                                ...
                                class="btn btn-primary btn-sm pros-load-schoolproceed-btn">Load</button>
            ...
            <div class="table-responsive prosloadshoolproceedcontent">
                        <div align="center" id="pros-load-loadschoolproceed">
