            ...
            <div class="row g-2">
                    <div class="col-md-2 col-lg-2">
                        <select style="color: #666666;"
                                class="form-select form-select-sm pros-load-campuspostransaction-balancesheet"
                    ...
                    <div class="col-md-2 col-lg-2">
                        <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosgetsession-balancesheet">
                    ...
                    <div class="col-md-3 col-lg-2">
                        ...
                        <select style="color: #666666;" class="form-select form-select-sm" aria-label=".form-select-sm example" id="prosloaterm-balancesheet">
                        ...
                        <div class="col-md-2 col-lg-2">
                            <div class="form-group" style="display: flex;">
                                ...
                                <button type="button"
                                    ...
                                    class="btn btn-primary btn-sm pros-load-balancesheet-btn">Load</button>
            ...
            <div class="table-responsive prosload-balancesheet-content">
                        <div align="center" id="pros-load-balancesheet-content">
