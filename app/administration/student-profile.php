                            ...
                            <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                                <div class="user-profile-info profileHeader">
                                    ...
                                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                        ...
                                        <i class='bx bx-pen'></i> <?php echo $regnumber; ?>
                                        </li>
                                        <li class="list-inline-item fw-semibold">
                                            <i class='bx bx-map'></i> 
                                                <span id="ctry">
                                                <?php
                                                $country_query = mysqli_query($link, "SELECT `CountryName` FROM `countries` WHERE countryID = '161'");
                                        ...
                                        <li class="list-inline-item fw-semibold">
                                        <i class='bx bx-calendar-alt'></i> <?php echo $StudentDOA; ?>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                ...
                                                <ul class="list-unstyled mb-4 mt-3" id="PersonalDetails">
                                                    <li class="d-flex align-items-center mb-3"><i class="bx bx-user"></i><span class="fw-semibold mx-2">Name:</span> <span>
                                                        <?php echo ucfirst(strtolower($StudentFirstName)); ?> 
                                                        <?php echo ucfirst(strtolower($StudentLastName)); ?> 
                                                        <?php echo ucfirst(strtolower($StudentMiddleName)); ?>
                                                    </span></li>
                                                ...
                                                <ul class="list-unstyled mb-4 mt-3" id="PersonalContacts">
                                                    ...
                                                    <li class="d-flex align-items-center mb-3"><i class="bx bx-map"></i><span class="fw-semibold mx-2">Address:</span> <span>
                                                        ...
                                                        $country_query2 = mysqli_query($link, "SELECT `CountryName` FROM `countries` WHERE countryID = '161'");
                                                        $fetch_Country2 = mysqli_fetch_assoc($country_query2);
                                                        $countryName2 = $fetch_Country2['CountryName'];

                                                        if ($countryName2 == '' || $countryName2 == 0) {
                                                            echo 'N/A';
                                                        } else {
                                                            echo ucfirst(strtolower($countryName));
                                                        }
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo $StudentFirstName; ?>" placeholder="Enter First Name" id="fname">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group local-forms">
                                            <label>Last Name </label>
                                            <input class="form-control" type="text" value="<?php echo $StudentLastName; ?>" placeholder="Enter First Name" id="lname">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group local-forms">
