var AppProcess = (function () {
  ...
  function eventProcess() {
    $("#miceMuteUnmute").on("click", async function () {
      ...
      if (isAudioMute) {
        audio.enabled = true;
        $(this).html(
          "<span class='material-icons prosactionsbuttons' >mic</span>"
        );
  ...
  async function videoProcess(newVideoState) {
    if (newVideoState == video_states.None) {
      ...
      $('.prosloaddummyimage').fadeIn();
      $('#locaVideoPlayer').fadeOut();
    ...
    if (newVideoState == video_states.Camera) {
      $('#locaVideoPlayer').fadeIn();
      $('.prosloaddummyimage').fadeOut();
      $("#videoCamOnOff").html(
        "<span class='material-icons prosactionsbuttons'>videocam_on</span>"
      );
    }
    try {
      var vstream = null;
    ...
    if (newVideoState == video_states.Camera) {
      $("#videoCamOnOff").html(
        '<span class="material-icons prosactionsbuttons" >videocam</span>'
      );
      $("#ScreenShareOnOf").html(
        '<span class="material-icons prosactionsbuttons">present_to_all</span>'
      );
      ...
      $("#ScreenShareOnOf").html(
        '<span class="material-icons text-success prosactionsbuttons">present_to_all</span>'
      );
    }
  }
...
var MyApp = (function () {
  ...
  function eventHandeling() {
    ...
    $("#btnsend").on("click", function () {
      ...
      }else
      {
            ...
            var div = `<div class="message-wrapper reverse" > <div class="profile-picture">
          ...
          <div class="message-content">
            <p  style="color:#00122e;" class="name">${user_id}</p>
      
            <div class="message">${ msgData}</div>
          </div>  </div>`;
  ...
  $(document).on("click", ".end-call-wrap", function () {
    ...
    $(".top-box-show")
      ...
      .html(
        '<div class="top-box align-vertical-middle profile-dialogue-show col-12"> <h4 class="mt-3" style="text-align:center;color:white;">Leave Meeting</h4> <hr> <div class="call-leave-cancel-action d-flex justify-content-center align-items-center w-100"> <a href="/action.html"><button class="call-leave-action btn btn-danger mr-5">Leave</button></a>&nbsp;&nbsp; <button class="call-cancel-action btn btn-secondary">Cancel</button> </div> </div>'
      );
  });
