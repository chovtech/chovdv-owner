...
<body>
    ...
    <script>
     ...
     $('body').on('click', '.abba_final_upload', function () {
            ...
            {
                  $('.abba_final_upload').prop('disabled', true);  
                ...
                $.ajax({
                    type: "POST",
                    url: "scripts/categoryandsub/prosupdatehostelandtransport.php",
                    data: fd,
                    contentType: false,
                    processData: false,
            
                    success: function (result) {
                         $('.abba_final_upload').prop('disabled', false);  
                        alert(result);
                        ...
                        if(result.trim() == 'success')
                        {
                              ...
                              $.wnoty({
                                        type: 'success',
                                        message: "Great!! Record Imported suceessfully.",
                                        autohideDelay: 5000
                                }); 
                        }else
                        {
