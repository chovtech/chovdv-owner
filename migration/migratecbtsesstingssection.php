...
<body>
    ...
    <div class="grid-container">
        ...
        <?php
                        ...
                        $prosverifycbt_content = mysqli_query($link, "SELECT * FROM `cbtsetquestionssettings`"); 
                               ...
                               if( $prosverifycbt_contentcnt > 0)
                               {
                                      ...
                                      do{
                                                      ...
                                                      $ClassOrDepartmentID = $prosverifycbt_content_fetch['ClassOrDepartmentID'];
                                                      ...
                                                      WHERE CampusID='$CampusID' AND ClassOrDepartmentID='$ClassOrDepartmentID'");
                                                        ...
                                                        if($prosgetsectioncnt > 0)
                                                        {
                                                                     ...
                                                                     $SectionID =  $prosgetsection_cntrow['SectionID'];
                                                                     
                                                                     
                                                                     $updatesettings = mysqli_query($link,"UPDATE `cbtsetquestionssettings` SET SectionID='$SectionID' WHERE ClassOrDepartmentID='$ClassOrDepartmentID' AND CampusID='$CampusID'");
