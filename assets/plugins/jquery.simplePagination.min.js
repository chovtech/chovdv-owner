    ...
    var a = {
        init: function(t) {
            var s = e.extend({
                ...
                i = this;
            return s.pages = s.pages ? s.pages : Math.ceil(s.items / s.itemsOnPage) ? Math.ceil(s.items / s.itemsOnPage) : 1, s.currentPage = s.currentPage - 1, s.halfDisplayed = s.displayedPages / 2, this.each(function() {
        ...
        _draw: function() {
            var t, s = this.data("pagination"),
                i = a._getInterval(s);
            a.destroy.call(this);
            var n = "UL" === this.prop("tagName") ? this : e("<ul></ul>").appendTo(this);
            if (s.prevText && a._appendItem.call(this, s.currentPage - 1, {
                    text: s.prevText,
                    classes: "prev"
                }), i.start > 0 && s.edges > 0) {
            ...
            if (i.end < s.pages && s.edges > 0)
                for (s.pages - s.edges > i.end && s.pages - s.edges - i.end != 1 ? n.append('<li class="disabled"><span class="ellipse">' + s.ellipseText + "</span></li>") : s.pages - s.edges - i.end == 1 && a._appendItem.call(this, i.end++), t = Math.max(s.pages - s.edges, i.end); t < s.pages; t++) a._appendItem.call(this, t);
            s.nextText && a._appendItem.call(this, s.currentPage + 1, {
                text: s.nextText,
                classes: "next"
            })
        },
        ...
        _appendItem: function(t, s) {
            var i, n, l = this,
                ...
                p = e("<li></li>"),
                d = l.find("ul");
            t = t < 0 ? 0 : t < r.pages ? t : r.pages - 1, i = e.extend({
                text: t + 1,
                classes: ""
            }, s || {}), t == r.currentPage || r.disabled ? (r.disabled ? p.addClass("disabled") : p.addClass("active"), n = e('<span class="current">' + i.text + "</span>")) : (n = e('<a href="' + r.hrefTextPrefix + (t + 1) + r.hrefTextSuffix + '" class="page-link">' + i.text + "</a>")).click(function(e) {
                return a._selectPage.call(l, t, e)
            }), i.classes && n.addClass(i.classes), p.append(n), d.length ? d.append(p) : l.append(p)
        },
