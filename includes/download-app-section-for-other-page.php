<div class="container-fluid"
			style="margin-top: 13%;background-image: url('../assets/images/website_images/checker.png');background-size:100%;background-repeat:no-repeat;">
			<div class="p-sm-5 mt-5" align="center">
				<h1 class="pt-5 mt-5 fs-1" style="color:#007bff;">
					<?php echo $website_download_app_txt1; ?> <br> <?php echo $website_download_app_txt2; ?>
				</h1>
			</div>
			<section class="gap-2 mt-1 pb-5" align="center">
			    ...
			    <div class="row" style="margin-top:50px;">
						<div class="col-12">
						    ...
						    <a href="<?php echo $defaultUrl.'school-management-system';?>" class="btn"
    								style="border: 2px solid #007bff;color:#007bff;border-radius: 8px;padding: 10px 25px 10px 25px;font-weight: 500;font-size:16px;background: transparent;">
    								<span>
    								Learn More
    								</span>
    						</a>
				...
				<!--<a href="#" class="btn shadow-sm franchise_appbtn_download">
					<span>
