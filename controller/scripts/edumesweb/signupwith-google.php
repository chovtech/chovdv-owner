          ...
          //   $consultantid = $getconsultinfo_cnt_row['UserID']; 
            ...
            //getting current session
             ...
             }else
             {
                  ...
                  // pros verify affiliate level two
                   ...
                   `Session`, `Term`,  `TokenDuration`,`Photo`) VALUES ('affiliate','$FName', '','$lastName','','$email','','$consultantid','$level_two','','$currentdate','$tagid','$session_startcount', '$TermOrSemesterID','','$image')");
            ...
            // insert into login table
             ...
             }else
             {
                 ...
                 $insertlogindetais = mysqli_query($link,"INSERT INTO `userlogin`(`InstitutionIDOrCampusID`, `UserID`, `UserRegNumberOrUsername`, `UserPassword`, `UserType`)
                   VALUES ('','$ownerid','$email','','affiliate')");
            ...
            $tokenurl = "{$defaultUrl}validate-password/?LcH6eMciwz3OOqP7KOrjjFf2V1DYE6=mkiuytrcccvvUR93vlqtfuRp3GPYGbHuyx9Y2LjWhr&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&oionxx=$ownerid&&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&lang=$lang&utype={$signup_as}";
