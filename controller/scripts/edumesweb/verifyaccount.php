...
ini_set('display_errors', 1);
        ...
        $sql = ("SELECT * FROM `userlogin` WHERE `UserID`='$userid' AND `UserRegNumberOrUsername`='$uname'");
        ...
        if ($row_cnt > 0) {
            ...
            if($usertype == 'owner')
            {
                    ...
                    $FName = $verifycheckuserinforow['AgencyOrSchoolOwnerName'];
                     $email = $verifycheckuserinforow['AgencyOrSchoolOwnerEmail'];

                    // school owner insert sqli
                        $insertownert = mysqli_query($link, "UPDATE `agencyorschoolowner` SET `TokenID`='$FiveDigitRandomNumber',`TokenDuration`='$expire_stamp' WHERE `AgencyOrSchoolOwnerID`='$userid'");
                     //school owner insert sqli
            }else{
                    ...
                    $FName = $verifycheckuserinforow['ConsultantName'];
                    $email = $verifycheckuserinforow['ConsultantEmail'];
                    $insertownert = mysqli_query($link, " UPDATE `consultant` SET `TokenID`='$FiveDigitRandomNumber',`TokenDuration`='$expire_stamp' WHERE `ConsultantID`='$userid'");
            }


            echo 'success';
            $tokenurl = $defaultUrl.="signup-verification/?LcH6eMciwz3OOqP7KOrjjFf2V1DYE6=mkiuytrcccvvUR93vlqtfuRp3GPYGbHuyx9Y2LjWhr&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&oionxx=$userid&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&marana=$email&kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6=UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr&tak=$FiveDigitRandomNumber&lang=$lang";


              $notifycationinsert = mysqli_query($link,"INSERT INTO `notifications`(`UserID`, `UserType`, `Description`,  `DateandTime`) VALUES ('$userid','owner','Congratulations for your account has been verified suucessfully kindly proceed to login','$currentdate')");//notification email
