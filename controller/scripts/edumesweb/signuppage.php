<?php
    ...
    else
    {
        ...
        // school owner insert sqli
        $insertownert = mysqli_query($link,"INSERT INTO `agencyorschoolowner`(`ConsultantID`, `AgencyOrSchoolOwnerName`,`AgencyOrSchoolOwnerNameTwo`,`AgencyOrSchoolOwnerMainPhone`,`AgencyOrSchoolOwnerEmail`,  `SessionOfSignup`, `TermOfSignup`, `DateOfSignup`,`TagState`,`TokenID`,`TokenDuration`)
        VALUES ('$consultantid','$FName','$lastName','$num','$email','$session_startcount','$termname','$currentdate','$tagid','$FiveDigitRandomNumber','$expire_stamp')");
