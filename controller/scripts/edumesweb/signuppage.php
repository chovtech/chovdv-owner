                    ...
                    else
                    {
                        ...
                        // school owner insert sqli
                            ...
                            // COLLECT referencenumber BASE ON USER TRYING TO SIGN UP HERE AND INSERT
                               ...
                               if ($signup_as == 'owner') {
                                    $insertownert = mysqli_query($link,"INSERT INTO `agencyorschoolowner`(`AffiliateID`, `AgencyOrSchoolOwnerName`,`AgencyOrSchoolOwnerNameTwo`,`AgencyOrSchoolOwnerMainPhone`,`AgencyOrSchoolOwnerEmail`,  `SessionOfSignup`, `TermOfSignup`, `DateOfSignup`,`TagState`,`TokenID`,`TokenDuration`)
