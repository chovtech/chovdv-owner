<?php
    ...
    $verifycheckuserinfocntrow = mysqli_fetch_assoc($verifycheck);
     
    $ownerid = $verifycheckuserinfocntrow['AgencyOrSchoolOwnerID'];
    $FName  =  $verifycheckuserinfocntrow['AgencyOrSchoolOwnerName'];
    ...
    if($verifycheckuserinfocnt > 0)
    {
        ...
        $tokenurl = $defaultUrl."validate-password/?LcH6eMciwz3OOqP7KOrjjFf2V1DYE6=mkiuytrcccvvUR93vlqtfuRp3GPYGbHuyx9Y2LjWhr&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&oionxx=$ownerid&&UR93vlqtfuRp3GPYGbHuyx9Y2LjWhr=kjgytrexcdsLcH6eMciwz3OOqP7KOrjjFf2V1DYE6&lang=$lang";
        
        echo 'verificationsent';
 
        $notifycationinsert = mysqli_query($link,"INSERT INTO `notifications`(`UserID`, `UserType`, `Description`,  `DateandTime`) VALUES ('$ownerid','owner','Password reset email has been sent to your email','$currenttime')");//notification email
                                                      ...
                                                      <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px 10px 30px;font-family:\'Cabin\',sans-serif;" align="left">
                                                         <div style="font-size: 10px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                            <p style="font-size: 14px; line-height: 160%;">
                                                               <span style="font-size: 14px; line-height: 16px;">Hi, '.$FName.'</span>
                                                            </p>
                                                            <p style="font-size: 14px; line-height: 160%;"></p>
                                                            <p style="font-size: 14px; line-height: 160%;">
                                                               <span style="font-size: 16px; line-height: 16px;">
                                                                  <strong>
                                                                     <span style="line-height: 16px;">Reset Password</span>
                                                                  </strong>
                                                               </span>
                                                            </p>
                                                            <p style="font-size: 14px; line-height: 160%;"></p>
                                                            <p style="font-size: 14px; line-height: 160%;">
                                                               <span style="font-size: 14px; line-height: 16px; color: #292929;">
                                                                  ...
                                                                  </span>Kindly click the link below to reset your password</span>
                                                            </p>
                                                            ...
                                                            <a href="'.$tokenurl.'" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:\'Cabin\',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #296beb; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:100%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 16px;">
                                                               <span style="display:block;padding:14px 44px 13px;line-height:120%;">
                                                                  <span style="line-height: 19.2px;">
                                                                     <strong>
                                                                        <span style="line-height: 19.2px;">Reset Password</span>
                                                                     </strong>
                                                                  </span>
                                                               </span>
                                                            </a>
