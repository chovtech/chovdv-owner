...
$campus = $_POST['emmaloadcampusforgoalsetting'];

    $display_cards = "SELECT * FROM `goalsetting` WHERE `CampusID` = '$campus' AND `DeleteStatus` = 0";
    ...
    if($display_cards_rows > 0){
                            ...
                            <div style="width: 100%; border-radius: 5px; background-color: #e8ebf1;">
                                <div style="padding: 5px;" align="center">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <span class="abba_tooltip">
                                                <button type="button" class="btn btn-sm text-white float-end m-2 rounded-3 btn-success mb-2 emma_goal_review_icon" style="font-size:11px;" data-id="'.$get_goal_id.'" data-bs-toggle="modal" data-bs-target="#emmareviewgoals">
        ...
        if($rows_for_no_record_found > 0){
            $getimage = $fetch_for_no_record_found['BaseSixtyFour'];

            echo '
                <div align="center" class="mt-4">
                    <div style="background-color:#ffffff;"> 
                        <img src="'.$getimage.'" alt="" style="width:15%;" class="mt-5">
                        <h6 class="pb-5 pt-1 text-secondary">No Records Found</h6>
                    </div>
                </div>';
        }else{
