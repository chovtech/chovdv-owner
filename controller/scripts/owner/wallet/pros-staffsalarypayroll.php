        ...
        if($selectect_staffcnt > 0)
        {
            ...
            <tbody>';
                ...
                do{
                    ...
                    $select_deciplinary = mysqli_query($link, "SELECT SUM(DisciplinaryAmount) AS DisciplinaryAmount FROM `staffdisciplinarylist` WHERE  InstitutionID='$InstitutionID' AND `StaffID`='$StaffID' AND DisciplinaryStatus='1' AND MonthApplied='$MonthPaid'");
                    ...
                    $select_deciplinarycnt_row = mysqli_fetch_assoc($select_deciplinary);
                     ...
                     if( $DisciplinaryAmount == '' ||  $DisciplinaryAmount == 'NULL' ||  $DisciplinaryAmount == '0') 
                     {
                     ...
                     }else
                     {
                        ...
                        $Newdeciplanry = number_format($DisciplinaryAmount);
