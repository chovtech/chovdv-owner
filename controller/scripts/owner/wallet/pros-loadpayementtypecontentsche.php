...
<?php
             ...
             if( $walletamount == '0')
             {
                ...
                echo '
                    <div class="col-md-7 col-12"> 
                        <div class="row"> 
                                  <input type="hidden" class="paymenttypeamountinputschedule prosgeammountforpayementtype" value="'.$walletamount.'"> 
        ...
        }else if($proscheckedpayementtype == 'saved')
        {
            ...
            if( $PayBackDate > $currentDate  )
            {
                ...
                <div class="col-md-7 col-12"> 
                    <div class="row"> 
                                  <input type="hidden" class="paymenttypeamountinputschedule" value="0"> 
