...
if($getsavedcontent_cnt > 0)
{
    ...
    do{
       ...
       echo '
                    <div class="card pb-2 mt-3" style="border:1px solid #E5E5E5;border-radius:15px;">
                    <div class="row">
                        <div class="col-8 d-flex align-items-center"
                            ...
                            <span style="font-size:13px;color:black;">'.$PlanTitle.' <br><span
                                    style="font-size:10px;color:black;">Date: '.$PayBackDate.' </span></span>
                        ...
                        <div class="col-12" align="center" style="padding-top:2px;">
                            <div class="me-2 ms-3" style="color:Red;font-size:14px;font-weight:600;">
                                Locked
                            </div>
                        </div>
                    </div>
