                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body text-secondary">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7 col-md-12">
                                                        <h6 class="card-title">'.$campusname.' <br><small style="font-size:11px;">';  
                                                                 echo 'Kindly edit or view  admission letter here.';
                                                        echo ' </small></h6>
                                                   </div>


                                                    <div class="col-lg-5 col-md-12">
                                                        <i class="fa fa-eye float-end text-primary prosloadprintresult" data-id="'.$campusID.'" data-bs-toggle="modal" data-bs-target="#prosloadapplicantstausmodal"  style="cursor:pointer;text-decoration: underline;font-size:11px;"> View admission letter</i>
                                                ...
                                                <button type="button"
                                                    class="btn btn-sm text-white float-end mt-2 rounded-3 btn-primary mb-2 prosloadadmissionletterbtn"
                                                    data-bs-toggle="modal" data-bs-target="#proseitadmissionlettermodal" style="font-size:11px;"
