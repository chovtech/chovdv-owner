<?php
            ...
            $select_topicverification =  mysqli_query($link,"SELECT * FROM `curriculumtopic` INNER JOIN 
             `campus` ON `curriculumtopic`.`CampusID` = `campus`.`CampusID` WHERE `campus`.`InstitutionID`='$abba_instituion_id'");
