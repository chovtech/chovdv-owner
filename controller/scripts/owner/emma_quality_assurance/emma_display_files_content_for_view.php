<?php
    ...
    $emma_files_for_second_folder = $_POST['emma_files_id_for_view'];

        $select_for_second_files = "SELECT * FROM `filestable` WHERE `FileTableID` = '$emma_files_for_second_folder' ORDER BY `FileName` ASC";
