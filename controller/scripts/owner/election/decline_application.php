<?php
    ...
    $approve_update = "UPDATE `electionapplicants` SET `Status`= 2 WHERE `ElectionApplicantsID`='$get_data_id' AND `CampusID`='$get_campus_id' AND `StudentID`='$get_student_id' ";
    ...
    $activity_log_description = 'Declined Election Application';
