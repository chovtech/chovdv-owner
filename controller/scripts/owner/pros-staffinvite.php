<?php
        ...
        $pros_staffemailinvite = explode(',', $_POST['pros_staffemailinvite']);
        $currentdate = date('m-d-Y');
        
        
                  
        
         $selectschool = mysqli_query($link,"SELECT * FROM `institution` WHERE InstitutionID='$groupofschoolID'");
        ...
        foreach($pros_staffemailinvite as $emailnewarr)
        {
          ...
          $emailnewarr;
                  ...
                  $staffverify = mysqli_query($link,"SELECT * FROM `staff` WHERE InstitutionID='$groupofschoolID' AND StaffEmail='$emailnewarr'");
                    ...
                    }else
                    {
                                  ...
                                  $insert_staff = mysqli_query($link,"INSERT INTO `staff`( `InstitutionID`, `Role`,`StaffEmail`,`DateHired`)
                            VALUES ('$groupofschoolID','$usertype','$emailnewarr','$currentdate')");
                                
                                
                                  $staffID =  mysqli_insert_id($link);
                                  
                                   $schoolurl = $schoollink."/staff-invite/?email=" . $emailnewarr . "&staffid=" . $staffID . "&usertype=" . $usertype;
                                                    ...
                                                    try {
                                                        ...
                                                        $mail->addAddress($emailnewarr, $nameto);     //Add a recipient
                                                        $mail->addAddress($emailnewarr);               //Name is optional
                                                        $mail->addReplyTo($email_to, $nameto);
                                                        $mail->addCC($emailnewarr);
                                                        $mail->addBCC($emailnewarr);
                                                                                              ...
                                                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px 10px 30px;font-family:\'Cabin\',sans-serif;" align="left">
                                                                                                 <div style="font-size: 10px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                      <span style="font-size: 14px; line-height: 16px;">Hello</span>
                                                                                                    </p>
                                                                                                    ...
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                      <span style="font-size: 14px; line-height: 16px; color: #292929;">
                                                                                                          <span style="line-height: 16px;">
                                                                                                             <strong></strong>
                                                                                                          </span> I hope this email finds you well. We are excited to invite you to join '.$schoolname.' staff community and create your account on our online platform.To get started, please click the button below to sign up
                                                                                     ...
                                                                                     <table style="font-family:\'Cabin\',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                                        <tbody>
                                                                                          <tr>
                                                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:\'Cabin\',sans-serif;" align="left">
                                                                                                 <div align="center">
                                                                                                    <a href="'.$schoolurl.'" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:\'Cabin\',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #296beb; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:100%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 16px;">
                                                                                                      <span style="display:block;padding:14px 44px 13px;line-height:120%;">
                                                                                                          <span style="line-height: 19.2px;">
                                                                                                             <strong>
                                                                                                                <span style="line-height: 19.2px;">Click to Sign up</span>
                                                                                                             </strong>
                                                                                                          </span>
                                                                                                      </span>
                                                                                                    </a>
