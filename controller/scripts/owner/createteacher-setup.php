<?php  
       ...
       $countinsertarray = array();
        ...
        if($maintag == '27' && $headfname[0] == '' || $headlastname[0] == '' || $heademail[0] == '' || $headnum[0] == '')
        {
            ...
            if($usertype == '')
            {
                ...
                //CREATE TEACHER HERE
                 ...
                 foreach($headfname as $key =>  $headfnamenew)
                 {
                        ...
                        $headfnamenew;
                        $headlastnamearr = mysqli_real_escape_string($link,$headlastname[$key]);
                        $heademailarr = $heademail[$key];
                        $headnumarr =  $headnum[$key];
                        
                        $headfnamearr =   mysqli_real_escape_string($link,$headfname[$key]);
                        ...
                        }else
                        {
                                ...
                                VALUES ('$groupSchoolID','teacher','$headfnamenew','$headlastnamearr', '$headnumarr','$heademailarr')");
                                ...
                                if($insert_staff == true)
                                {
                                      ...
                                      $countinsertarray[] = $countinsert++;
                                        ...
                                        VALUES ('$groupSchoolID','$staffID','$heademailarr','$passwordmd5','teacher')");
                                                                                              ...
                                                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px 10px 30px;font-family:\'Cabin\',sans-serif;" align="left">
                                                                                                 <div style="font-size: 10px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                       <span style="font-size: 14px; line-height: 16px;">Hi '. $headfnamearr.'</span>
                                                                                                    </p>
                                                                                                    ...
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                       <span style="font-size: 14px; line-height: 16px; color: #292929;">
                                                                                                          <span style="line-height: 16px;">
                                                                                                             <strong></strong>
                                                                                                          </span> on your appointment as the new School teacher at '.$schoolname.'! Here are your temporary login details you can login and edit it.</span>
                                                                                                    </p>
                  ...
                  //CREATE TEACHER HERE
                     ...
                     $combinedString = count($countexistarray);

                     $combinedString2 = count($countinsertarray);
  
                     if($combinedString > 0)
                     {
                           if($combinedString2 == '0')
                           {
                              echo 'allexist';
                           }else
                           {
                 ...
                 //CREATE OTHER STAFF FOR SETUP
                    ...
                    foreach($headfname as $key =>  $headfnamenew)
                    {
                           ...
                           }else
                           {
                                 ...
                                 {
                                         $insert_staff = mysqli_query($link,"INSERT INTO `staff`( `InstitutionID`,  `Role`, `StaffFirstName`,  `StaffLastName`, `StaffMainNumber`, `StaffEmail`)
                                       VALUES ('$groupSchoolID','$usertype','$headfnamenew','$headlastnamearr', '$headnumarr','$heademailarr')");
                                 }else
                                 {
                                     
                                     $insert_staff = mysqli_query($link,"INSERT INTO `staff`( `InstitutionID`,  `Role`, `StaffFirstName`,  `StaffLastName`, `StaffMainNumber`, `StaffEmail`,`StaffType`)
                                    VALUES ('$groupSchoolID','$usertype','$headfnamenew','$headlastnamearr', '$headnumarr','$heademailarr','1')");
                                           ...
                                           $staffID =  mysqli_insert_id($link);
                                           $insertlogin = mysqli_query($link,"INSERT INTO `userlogin`(`InstitutionIDOrCampusID`, `UserID`, `UserRegNumberOrUsername`, `UserPassword`, `UserType`) 
                                           VALUES ('$groupSchoolID','$staffID','$heademailarr','$passwordmd5','$usertype')");
                                                                                        ...
                                                                                        <tbody>
                                                                                           <tr>
                                                                                              <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 55px 10px 30px;font-family:\'Cabin\',sans-serif;" align="left">
                                                                                                 <div style="font-size: 10px; line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                       <span style="font-size: 14px; line-height: 16px;">Hi '.$headfnamearrr.'</span>
                                                                                                    </p>
                                                                                                    <p style="font-size: 14px; line-height: 160%;"></p>
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                       <span style="font-size: 16px; line-height: 16px;">
                                                                                                    ...
                                                                                                    <p style="font-size: 14px; line-height: 160%;">
                                                                                                       <span style="font-size: 14px; line-height: 16px; color: #292929;">
                                                                                                          <span style="line-height: 16px;">
                                                                                                             <strong></strong>
                                                                                                          </span> on your appointment as the new School '.$usertype.' at '.$schoolname.'! Here are your temporary login details you can login and edit it.</span>
                                                                                                    </p>
