<?php
    ...
    if($sql_affiliate_cnt > 0)
    {
        do{
            ...
            if($level_1 == $user_id)
            {
                ...
                $sql_affiliate_earning_l1 = mysqli_query($link, "SELECT SUM(amount) as earning_amt FROM `affiliate_earning` WHERE `affiliate_id` = '$user_id'
                AND `sub_affiliate_id` = '$affiliate_id' AND `earning_type` = 'level_1' AND `transaction_type` = 'credit'");
            ...
            elseif($level_2 == $user_id)
            {
                ...
                $sql_affiliate_earning_l2 = mysqli_query($link, "SELECT SUM(amount) as earning_amt FROM `affiliate_earning`
                WHERE `affiliate_id` = '$user_id' AND `sub_affiliate_id` = '$affiliate_id' AND `earning_type` = 'level_2' AND `transaction_type` = 'credit'");
    ...
    if ($sql_affiliate_l1_db_cnt > 0) {
        ...
        $sql_affiliate_earning_l1_query = "SELECT SUM(amount) as earning_amt_db FROM `affiliate_earning` WHERE affiliate_id = '$user_id' 
        AND sub_affiliate_id = '$affiliate_id_db' AND earning_type = 'level_1' AND `transaction_type` = 'credit'";
    ...
    if ($sql_affiliate_l2_db_cnt > 0) {
        ...
        $sql_affiliate_earning_l2_query = "SELECT SUM(amount) as earning_amt_db FROM `affiliate_earning` WHERE affiliate_id = '$user_id'
        AND sub_affiliate_id = '$affiliate_id_2_db' AND earning_type = 'level_2' AND `transaction_type` = 'credit'";
