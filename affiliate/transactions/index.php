                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-xl-9 col-md-6 mb-1">
                            <div class="input-group mb-3" style="width:65%;">
                                ...
                                <input type="text" class="form-control form-control-sm" id="searchInput" placeholder="Search by Name, Ref. Number, Type, Amount..." aria-label="Search" aria-describedby="basic-addon1">
                            </div>
                        </div>
