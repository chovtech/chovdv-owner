        ...
        <main class="main-container">
            <div class="main-cards">
                <div class="notif-center-container" aria-label="Notifications" tabindex="0">
                    <!-- Back button -->
                    <a href="../home/" class="btn btn-light mb-2"
                        style="display:inline-flex;align-items:center;gap:6px;border-radius:8px;font-weight:500;font-size:1rem;"><i
                    ...
                    <?php else: ?>
                        <?php $first = true;
                        foreach ($paginatedGrouped as $label => $group): ?>
                            <?php if (count($group) > 0): ?>
                                <?php if (!$first): ?>
                                    <hr class="notif-divider" /><?php endif;
                                $first = false; ?>
                                ...
                                <div class="row notif-list" role="list">
                                    <?php foreach ($group as $n): ?>
                                        <div class="col-12">
                                            <a href="#"
                                                class="notif-fb-card <?php echo $n['ViewStatus'] == 0 ? 'notif-fb-unread' : 'notif-fb-read'; ?>"
                                                data-id="<?php echo $n['NotificationID']; ?>" tabindex="0" role="listitem"
                                                ...
                                                <span
                                                    class="notif-fb-dot<?php echo $n['ViewStatus'] == 0 ? '' : ' notif-fb-dot-read'; ?>"></span>
                                            </a>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
