  ...
  // import setup here  
    ...
    // INSERT TOPIC START START HERE
            ...
            $('body').on('click', '#pros-appenbtn-addRownew-subtopic', function(e) {
                ...
                var topicInput_subtopic = '<div class="mt-4 prosremovecardfortopicappendsubtopic' + maintosubtopicnum +'">' +
                            '<div class="row " >' +
                                '<div class="col-sm-6">' +
                                    '<div class="form-group local-forms">' +
                                ...
                                '<div class="col-3">' +
                                      '<span class="fa fa-times mt-4 text-danger prosproceedtoremovesubtopicbtn"  data-tag="'+getmaintopicid+'" data-id="'+ maintosubtopicnum +'" style="font-size:16px;cursor:pointer;"></span>' +
                                '</div>'+
            ...
            $('#prosloadschemeworkforedit').html('<div align="center"> <i class="fas fa-spinner fa-spin fs-1" style="color:#007ffb;"></i></div>');
                ...
                $.ajax({
                    ...
                    $('body').on('click', '#pros-appenbtn-addRownew-subtopicedit', function(e) {
                                ...
                                var getmaintopicid = $(this).data('id');
                                var numappended = $("#proscollect-topicollectedsubedit"+getmaintopicid).val();
                                numappended++;
                                var weeekno = numappended + 1;
                                ...
                                var topicInput_subtopic_edit = '<div class="mt-4 prosremovecardfortopicappendsubtopicedit' + maintosubtopicnum +'">' +
                                        '<div class="row " >' +
                                            ...
                                            '<div class="col-3">' +
                                                    '<span class="fa fa-times mt-4 text-danger prosproceedtoremovesubtopicbtnedit"  data-tag="'+getmaintopicid+'" data-id="'+ maintosubtopicnum +'" style="font-size:16px;cursor:pointer;"></span>' +
                                            '</div>'+
                                    ...
                                    $(".prosisplaysubtopiceach1edit"+getmaintopicid).append(topicInput_subtopic_edit);
                                    $("#proscollect-topicollectedsubedit"+getmaintopicid).val(weeekno);
                                });
                            }
                        });
